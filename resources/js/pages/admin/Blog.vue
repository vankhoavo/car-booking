...
const openCreate = () => { editing.value = null; form.value = empty(); };
const openEdit = (post: Post) => { editing.value = post; form.value = { ...post }; };
