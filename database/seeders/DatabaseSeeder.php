...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        BlogPost::updateOrCreate(['slug' => 'kinh-nghiem-thue-xe-theo-ngay'], [
            'title' => 'Kinh nghiệm thuê xe theo ngày',
            'excerpt' => 'Những điều nên kiểm tra trước khi chọn xe và gửi yêu cầu thuê.',
            'content' => 'Kiểm tra số chỗ, thời gian thuê, điểm nhận trả và tình trạng xe. Hãy gửi thông tin đầy đủ để chúng tôi tư vấn và xác nhận lịch xe phù hợp.',
            'image' => null,
            'published_at' => now()->toDateString(),
            'is_published' => true,
        ]);

        BlogPost::updateOrCreate(['slug' => 'cach-chon-xe-cho-chuyen-di-gia-dinh'], [
            'title' => 'Cách chọn xe cho chuyến đi gia đình',
            'excerpt' => 'Ưu tiên số chỗ, hành lý và sự thoải mái để chuyến đi nhẹ nhàng hơn.',
            'content' => 'Nhóm đông nên ưu tiên xe 7 chỗ. Nếu mang nhiều hành lý, nên chọn không gian cabin rộng và xác nhận trước nhu cầu với đơn vị cung cấp dịch vụ.',
            'image' => null,
